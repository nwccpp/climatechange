...
########################################
### Read scraped file
articles = pd.read_csv("/projects/p31516/mah3870/climate_change_project/Contrarian Claims/ICA_Submission/data/v2/NW_CC_2017_lowcred_v2.csv", encoding = "ISO-8859-1",engine="python",error_bad_lines=False, usecols=["master_index","text","link","date","url_to_test"])
...
claims_df.to_csv("/projects/p31516/mah3870/output/claims_v2/{}_claims.csv".format(year), index=False)
claims_df.to_csv("/projects/p31516/mah3870/output/claims_v2/{}_claims.txt".format(year), sep=",", index=False)
